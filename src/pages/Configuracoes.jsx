      ...
      <div className="page-inner" style={{ paddingTop: 16 }}>
        ...
        <div className="field-row">
          <div>
            ...
            <input className="field-input" type="number" min="0" max="99" step="0.5" value={cfg.taxa99} onChange={e => set('taxa99', e.target.value)} />
          </div>
          <div>
            <div className="field-label">Taxa iFood (%)</div>
            <input className="field-input" type="number" min="0" max="99" step="0.5" value={cfg.taxaIfood} onChange={e => set('taxaIfood', e.target.value)} />
          </div>
        </div>
